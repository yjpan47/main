...
public class StatusBarFooterTest extends GuiUnitTest {
    ...
    @Before
    public void setUp() {
        StatusBarFooter statusBarFooter = new StatusBarFooter(STUB_SAVE_LOCATION, personnelDatabase);
    ...
    public void display() {
        ...
        // after personnel database is updated
        guiRobot.interact(() -> personnelDatabase.addPerson(ALICE));
