...
public class LogicManagerTest {
    ...
    private void assertCommandBehavior(Class<?> expectedException, String inputCommand,
        ...
        try {
            CommandResult result = logic.execute(inputCommand, UserType.ADMIN, UserType.DEFAULT_ADMIN_USERNAME);
     ...
     */
    private static class JsonPersonnelDatabaseIoExceptionThrowingStub extends JsonPersonnelDatabaseStorage {
        private JsonPersonnelDatabaseIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
