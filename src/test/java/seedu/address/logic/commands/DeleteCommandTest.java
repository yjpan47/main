...
public class DeleteCommandTest {
    ...
    private Model model = new ModelManager(getTypicalAddressBook(), new DutyCalendar(), new UserPrefs());
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        ModelManager expectedModel = new ModelManager(model.getAddressBook(), new DutyCalendar(), new UserPrefs());
    ...
    public void execute_validIndexFilteredList_success() {
        ...
        Model expectedModel = new ModelManager(model.getAddressBook(), new DutyCalendar(), new UserPrefs());
        expectedModel.deletePerson(personToDelete);
        expectedModel.commitAddressBook();
