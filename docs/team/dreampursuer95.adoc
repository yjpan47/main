...
* *Other contributions*: fixing of test cases to fit our current use, setting up of the group Github account and the main repository, setting up Travis testing within our own repository, contribution of ideas for Duty Planner

** Project management:
*** Managed releases `v1.0` - `v1.3rc` (4 releases) on GitHub
...
include::../DeveloperGuide.adoc[tag=undoredo] Section 3.5
