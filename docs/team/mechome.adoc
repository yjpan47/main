...
* *Major enhancement*: added *the ability to request swapping of duties, respond to swap requests and approve or reject swap requests.*
...
** Documentation:
*** Edited the User Guide to reflect our product: https://github.com[#14]
** Community:
