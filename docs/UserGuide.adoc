...
* If you close the login window, you are still able to view the personnel list and the calendar duty list.
...
[IMPORTANT] This command can only be entered if next month's duty schedule has not been confirmed yet.
...
The user can remove the dates they have blocked for the upcoming month. +
Format: `removeblock`
