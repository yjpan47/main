...
==== Approve Swap Command : `acceptSwap`
The General User can use this command to accept a certain swap at the given index on the open Swap Requests list.

Format : `approveSwap i/INDEX`
...
Once a satisfactory duty schedule is generated, the administrator can go ahead to confirm the duty schedule. (See <<Confirm a schedule>>)
...
==== Duty Settings Command : `settings`
This command allows you to view and modify the number of points and manpower required for each day. +
There are two ways to call this function. +

* Entering `settings` will allow you to view the manpower and points required for each day. +
* Entering `settings d/DAY m/MANPOWER p/POINTS` will allow you to modify the manpower and points for the entered day. +
Points and manpower entered have to be positive integers. Day has to be a valid day of the week from Monday to Sunday.

Example: +
`settings d/Monday m/1 p/1`'

==== View Swap Command : `viewSwaps`
Used to view all the swap requests that have been submitted by personnel. The Admin User can then accept or reject the swap

Format : `viewSwaps`

==== Approve Swap Command : `approveSwap`
The Admin User can use this command to approve a certain swap at the given index on the requested Swap list.

Format : `approveSwap i/INDEX`

==== Reject Swap Command : `rejectSwap`
The Admin User can use this command to reject a certain swap at the given index on the swap requests list.

Format : `rejectSwap i/INDEX`
