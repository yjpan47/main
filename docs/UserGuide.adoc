...
==== Accept Swap Commands : `acceptSwap`
The Admin User can use this command to accept a certain swap at the given index on the swap requests list.

Format : `acceptSwap i/INDEX`

==== Reject Swap Commands : `rejectSwap`
