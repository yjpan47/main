...
1. Admin has a list of personnel and runs schedule.
2. A list of duties for the next month shows up.
3. He sees the schedule and is happy with it so he confirms.
4. Next month's duty is confirmed
+
Use case ends.
...
1. A general user wants to see his own duties and enters view.
2. A list of his duties for the upcoming month are shown.
+
Use case ends.
