...
= Duty Allocation - Developer Guide
...
=== Duty Calendar and allocation algorithm
...
`DutySettings` class enables the users to customise the number of points and capacity for each day of Duty
