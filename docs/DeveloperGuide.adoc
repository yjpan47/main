...
1. User requests to schedule for the next month
2. User the confirm the schedule
3. User deletes a person from the database
4. Schedule is now unconfirmed and has to be run again+
Use case ends.
